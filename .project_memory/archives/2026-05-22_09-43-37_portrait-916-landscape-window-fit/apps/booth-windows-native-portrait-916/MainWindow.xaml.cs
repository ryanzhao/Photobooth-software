...
public partial class MainWindow : Window
{
    ...
    private void ApplyWindowOrientation()
    {
        ...
        if (portrait)
        {
            ...
            MainColumnLeft.Width = new GridLength(1d, GridUnitType.Star);
            MainColumnRight.Width = new GridLength(0d, GridUnitType.Pixel);
            MainControlsRow.Height = GridLength.Auto;

            Grid.SetColumn(MainStagePane, 0);
            Grid.SetRow(MainStagePane, 1);
            MainStagePane.Margin = new Thickness(0, 0, 0, 16);

            Grid.SetColumn(MainControlsPane, 0);
            Grid.SetRow(MainControlsPane, 2);
